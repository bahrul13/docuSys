...
require_once __DIR__ . '/../handlers/view_copc.php';
...
<title>View COPC Document</title>
    ...
    <?php if ($fileExists): ?>
      <div class="pdf-container">
        ...
        <div class="pdf-buttons">
          <a href="../handlers/download.php?folder=copc&file=<?= urlencode($doc['file_name']) ?>&doc_id=<?= (int)$doc['id'] ?>">
            Download
          </a>

          <a href="../users/copc.php" class="back-btn">
...
<div id="fileErrorModal" class="modal" style="display:block;">
  <div class="modal-content">
    ...
    <h1>Error</h1>
    <p>❌ The requested COPC document was not found or may have been removed.</p>
