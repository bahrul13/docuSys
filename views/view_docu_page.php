...
require_once __DIR__ . '/../handlers/view_docu.php';
...
<title>View Accreditaion-Related Document</title>
    ...
    <?php if ($fileExists): ?>
      <div class="pdf-container">
        ...
        <div class="pdf-buttons">
          <a href="../handlers/download.php?folder=other&file=<?= urlencode($doc['file_name']) ?>&doc_id=<?= (int)$doc['id'] ?>">
            Download
          </a>
...
function closeFileErrorModal() {
  ...
  window.location.href = "../users/other.php";
}
</script>
